...
/**
 * The multisite_helper_entity_processor attribute.
 */
#[\Attribute(\Attribute::TARGET_CLASS)]
final class MultisiteHelperEntityProcessor extends AttributeBase {

  /**
   * Constructs a new MultisiteHelperEntityProcessor instance.
   *
   * @param string $id
