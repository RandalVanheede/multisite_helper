...
namespace Drupal\multisite_helper\Attribute;

use Drupal\Component\Plugin\Attribute\AttributeBase;
use Drupal\Core\StringTranslation\TranslatableMarkup;

/**
 * The multisite_helper_plugin attribute.
 */
#[\Attribute(\Attribute::TARGET_CLASS)]
final class MultisiteHelperPlugin extends AttributeBase {

  /**
   * Constructs a new MultisiteHelperPlugin instance.
   *
   * @param string $id
  ...
  public function __construct(
    ...
    public readonly ?string $handles_entity_type = NULL,
